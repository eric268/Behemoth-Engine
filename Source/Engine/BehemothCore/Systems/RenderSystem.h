...
namespace Behemoth
{
	...
	private:
		void DrawMesh(Mesh& mesh, bool isVisible, bool drawWireFrame, const Math::Vector3 cameraPosition, const TransformComponent* meshTransform, const Math::Matrix4x4& viewProjMatrix);
		void DrawBoundingVolume(Mesh& mesh, const float radius, const Math::Vector3& cameraPosition, const TransformComponent* meshTransform, const Math::Matrix4x4& viewProjMatrix);
