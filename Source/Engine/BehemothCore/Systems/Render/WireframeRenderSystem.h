...
namespace Behemoth
{
	...
	protected:
		void ProcessWireframe(Mesh& mesh, const Math::Matrix4x4& transform, const Math::Matrix4x4& viewProjMatrix, const Math::Vector3& scale, bool dirty = true, Math::Vector3 color = Math::Vector3(1.0f, 1.0f, 1.0f));
