...
GameOverScene::GameOverScene()
{
	...
	registry.AddComponent<Behemoth::TextComponent>(finalScoreUIHandle, GetFinalScoreText(), BMath::Vector2(0, 0.5));
	controlsUIHandle = registry.CreateEntity("Exit controls text");
}
